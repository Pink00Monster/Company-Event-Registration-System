<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Participants.aspx.cs" Inherits=" EventRegistrationWebsite.Employees" %>
                ...
                <div class="col-sm-12">
                    <asp:GridView ID="gvEmployees" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CompanyName" HeaderText="Events">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbDelEmployee" Text="Del" runat="server"
                                        OnClientClick="return confirm('Are you sure you want to delete this participant?');" CommandName="Delete" />
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" />
            ...
            <div class="modal-dialog modal-lg" style="width: 600px;">
                <div class="modal-content" style="font-size: 11px;">
                    ...
                    <div class="modal-header" style="text-align: center;">
                        <asp:Label ID="lblEmployeeNew" runat="server" Text="Add New Participant" Font-Size="24px" Font-Bold="true" />
                        <asp:Label ID="lblEmployeeUpd" runat="server" Text="View / Update a Participant" Font-Size="24px" Font-Bold="true" />
                    </div>
                                    ...
                                    <div class="row" style="margin-top: 20px;">
                                        ...
                                        <div class="col-sm-10">
                                            <asp:TextBox ID="txtEmployeeName" runat="server" MaxLength="255" CssClass="form-control input-xs" 
                                                ...
                                                AutoCompleteType="Disabled" placeholder="Participant Name" />
